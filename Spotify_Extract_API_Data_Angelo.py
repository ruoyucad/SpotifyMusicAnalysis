...
def API_get_audio_feature(songids, audioF):
    '''
    params:
    songids : id of the song;
    audioF : features of the specific audio
    '''
    #print(songids)
    ...
    access_token = ('Bearer BQAHQvsbS6XwkNwaFvTfV0fRc8OXoISzdmpn87tVWU8w_JWG8cQ3lplFYbSqNbUVMJEt09Dt6Q36jwsTxbgpW7tzlQoQIkuO04zcT0Vv0UQvAesLiujTpdnxgEnXH59ReFY1txyogpeEO8r6bKF9MM1rTeLVyYA')
    	          
    req = requests.get(url, headers={"Accept": "application/json" , "Authorization": access_token})
...
def main():
    #loop through 20ish year of music data
    ...
    for query in queries:
        ...
        data3 =  [  'artist_id',  'artist_genres',  'artist_popularity']
        
        data4 =  [  'album_id',  'album_genres',   'album_popularity',  'album_release_date']
        ...
        df1 = pd.DataFrame(ltrack, columns=data1)
        
        df2 = pd.DataFrame(audioF, columns=data2) 
        
        
        df3 = pd.DataFrame(artist_data, columns=data3)
        
        df4 = pd.DataFrame(album_data, columns=data4)
